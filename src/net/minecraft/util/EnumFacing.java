...
public enum EnumFacing implements IStringSerializable {
    ...
    EnumFacing(final int indexIn, final int oppositeIn, final int horizontalIndexIn, final String nameIn, final AxisDirection axisDirectionIn, final Axis axisIn, final Vec3i directionVecIn) {
        this.index = indexIn;
    ...
    public enum Axis implements Predicate<EnumFacing>, IStringSerializable {
        ...
        Axis(final String name, final Plane plane) {
            this.name = name;
            this.plane = plane;
        }
