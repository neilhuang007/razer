...
public class StructureStrongholdPieces {
    ...
    public static void prepareStructurePieces() {
        ...
        for (final PieceWeight structurestrongholdpieces$pieceweight : pieceWeightArray) {
    ...
    private static boolean canAddStructurePieces() {
        ...
        for (final PieceWeight structurestrongholdpieces$pieceweight : structurePieceList) {
    ...
    private static Stronghold func_175955_b(final Stairs2 p_175955_0_, final List<StructureComponent> p_175955_1_, final Random p_175955_2_, final int p_175955_3_, final int p_175955_4_, final int p_175955_5_, final EnumFacing p_175955_6_, final int p_175955_7_) {
        if (!canAddStructurePieces()) {
            ...
            if (strongComponentType != null) {
                final Stronghold structurestrongholdpieces$stronghold = func_175954_a(strongComponentType, p_175955_1_, p_175955_2_, p_175955_3_, p_175955_4_, p_175955_5_, p_175955_6_, p_175955_7_);
                strongComponentType = null;
            ...
            while (j < 5) {
                ...
                for (final PieceWeight structurestrongholdpieces$pieceweight : structurePieceList) {
                    ...
                    if (i < 0) {
                        ...
                        final Stronghold structurestrongholdpieces$stronghold1 = func_175954_a(structurestrongholdpieces$pieceweight.pieceClass, p_175955_1_, p_175955_2_, p_175955_3_, p_175955_4_, p_175955_5_, p_175955_6_, p_175955_7_);
