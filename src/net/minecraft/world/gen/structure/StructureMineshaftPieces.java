...
public class StructureMineshaftPieces {
    ...
    private static StructureComponent func_175892_a(final List<StructureComponent> listIn, final Random rand, final int x, final int y, final int z, final EnumFacing facing, final int type) {
        ...
        if (i >= 80) {
            ...
            final StructureBoundingBox structureboundingbox1 = Stairs.func_175812_a(listIn, rand, x, y, z, facing);

            if (structureboundingbox1 != null) {
                return new Stairs(type, rand, structureboundingbox1, facing);
            }
        } else {
            final StructureBoundingBox structureboundingbox2 = Corridor.func_175814_a(listIn, rand, x, y, z, facing);
