...
public class StructureOceanMonumentPieces {
    ...
    public static class DoubleXRoom extends Piece {
        ...
        public boolean addComponentParts(final World worldIn, final Random randomIn, final StructureBoundingBox structureBoundingBoxIn) {
            ...
            final RoomDefinition structureoceanmonumentpieces$roomdefinition1 = this.field_175830_k;
    ...
    public static class DoubleXYRoom extends Piece {
        ...
        public boolean addComponentParts(final World worldIn, final Random randomIn, final StructureBoundingBox structureBoundingBoxIn) {
            final RoomDefinition structureoceanmonumentpieces$roomdefinition = this.field_175830_k.field_175965_b[EnumFacing.EAST.getIndex()];
            final RoomDefinition structureoceanmonumentpieces$roomdefinition1 = this.field_175830_k;
            final RoomDefinition structureoceanmonumentpieces$roomdefinition2 = structureoceanmonumentpieces$roomdefinition1.field_175965_b[EnumFacing.UP.getIndex()];
    ...
    public static class DoubleYZRoom extends Piece {
        ...
        public boolean addComponentParts(final World worldIn, final Random randomIn, final StructureBoundingBox structureBoundingBoxIn) {
            ...
            final RoomDefinition structureoceanmonumentpieces$roomdefinition1 = this.field_175830_k;
            final RoomDefinition structureoceanmonumentpieces$roomdefinition2 = structureoceanmonumentpieces$roomdefinition.field_175965_b[EnumFacing.UP.getIndex()];
            final RoomDefinition structureoceanmonumentpieces$roomdefinition3 = structureoceanmonumentpieces$roomdefinition1.field_175965_b[EnumFacing.UP.getIndex()];
    ...
    public static class MonumentBuilding extends Piece {
        ...
        public MonumentBuilding(final Random p_i45599_1_, final int p_i45599_2_, final int p_i45599_3_, final EnumFacing p_i45599_4_) {
            ...
            final List<MonumentRoomFitHelper> list1 = Lists.newArrayList();
        ...
        private List<RoomDefinition> func_175836_a(final Random p_175836_1_) {
            ...
            final RoomDefinition structureoceanmonumentpieces$roomdefinition1;
            ...
            for (final RoomDefinition structureoceanmonumentpieces$roomdefinition3 : list) {
                int j5 = 0;
                int k5 = 0;
