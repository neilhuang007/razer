...
public class PlayerProfileCache {
    ...
    private void addEntry(final GameProfile gameProfile, Date expirationDate) {
        ...
        if (this.uuidToProfileEntryMap.containsKey(uuid)) {
            final ProfileEntry playerprofilecache$profileentry1 = this.uuidToProfileEntryMap.get(uuid);
    ...
    public void load() {
        ...
        try {
            ...
            final List<ProfileEntry> list = this.gson.fromJson(bufferedreader, TYPE);
            ...
            if (p_deserialize_1_.isJsonObject()) {
                ...
                if (jsonelement != null && jsonelement1 != null) {
                    ...
                    if (s1 != null && s != null) {
                        ...
                        final ProfileEntry playerprofilecache$profileentry = PlayerProfileCache.this.new ProfileEntry(new GameProfile(uuid, s1), date);
                        return playerprofilecache$profileentry;
                    } else {
                        return null;
                    }
