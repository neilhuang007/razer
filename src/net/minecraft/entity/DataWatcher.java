...
public class DataWatcher {
    ...
    public <T> void addObject(final int id, final T object) {
        ...
        if (integer == null) {
            ...
            final WatchableObject datawatcher$watchableobject = new WatchableObject(integer.intValue(), id, object);
    ...
    private WatchableObject getWatchedObject(final int id) {
        ...
        final WatchableObject datawatcher$watchableobject;
    ...
    public void updateWatchedObjectsFromList(final List<WatchableObject> p_75687_1_) {
        ...
        for (final WatchableObject datawatcher$watchableobject : p_75687_1_) {
            final WatchableObject datawatcher$watchableobject1 = this.watchedObjects.get(Integer.valueOf(datawatcher$watchableobject.getDataValueId()));
