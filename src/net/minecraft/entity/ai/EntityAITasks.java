    ...
    public void onUpdateTasks() {
        ...
        if (this.tickCount++ % this.tickRate == 0) {
            ...
            while (iterator1.hasNext()) {
                final EntityAITaskEntry entityaitasks$entityaitaskentry1 = iterator1.next();
        ...
        for (final EntityAITaskEntry entityaitasks$entityaitaskentry2 : this.executingTaskEntries) {
