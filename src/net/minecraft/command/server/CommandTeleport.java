        ...
        if (args.length < 1) {
            ...
            if (args.length != 1 && args.length != 2) {
                if (args.length < i + 3) {
                    ...
                    int lvt_5_2_ = i + 1;
                    final CoordinateArg commandbase$coordinatearg = parseCoordinate(entity.posX, args[i], true);
                    final CoordinateArg commandbase$coordinatearg1 = parseCoordinate(entity.posY, args[lvt_5_2_++], 0, 0, false);
                    final CoordinateArg commandbase$coordinatearg2 = parseCoordinate(entity.posZ, args[lvt_5_2_++], true);
                    final CoordinateArg commandbase$coordinatearg3 = parseCoordinate(entity.rotationYaw, args.length > lvt_5_2_ ? args[lvt_5_2_++] : "~", false);
                    final CoordinateArg commandbase$coordinatearg4 = parseCoordinate(entity.rotationPitch, args.length > lvt_5_2_ ? args[lvt_5_2_] : "~", false);
