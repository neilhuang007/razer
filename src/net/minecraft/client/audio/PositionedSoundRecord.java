...
public class PositionedSoundRecord extends PositionedSound {
    ...
    private PositionedSoundRecord(final ResourceLocation soundResource, final float volume, final float pitch, final boolean repeat, final int repeatDelay, final AttenuationType attenuationType, final float xPosition, final float yPosition, final float zPosition) {
        super(soundResource);
        this.volume = volume;
        this.pitch = pitch;
