...
public class GuiPageButtonList extends GuiListExtended {
    ...
    private void func_178069_s() {
        for (final GuiListEntry[] aguipagebuttonlist$guilistentry : this.field_178078_x) {
            for (int i = 0; i < aguipagebuttonlist$guilistentry.length; i += 2) {
                ...
                final GuiListEntry guipagebuttonlist$guilistentry1 = i < aguipagebuttonlist$guilistentry.length - 1 ? aguipagebuttonlist$guilistentry[i + 1] : null;
                ...
                final GuiEntry guipagebuttonlist$guientry = new GuiEntry(gui, gui1);
    ...
    private void func_178055_t() {
        ...
        for (int i = 0; i < this.field_178078_x[this.field_178077_y].length; i += 2) {
            ...
            final GuiListEntry guipagebuttonlist$guilistentry1 = i < this.field_178078_x[this.field_178077_y].length - 1 ? this.field_178078_x[this.field_178077_y][i + 1] : null;
    ...
    private void func_178060_e(final int p_178060_1_, final int p_178060_2_) {
        ...
        for (final GuiListEntry guipagebuttonlist$guilistentry1 : this.field_178078_x[p_178060_2_]) {
