...
public abstract class BlockFlower extends BlockBush {
    ...
    public enum EnumFlowerType implements IStringSerializable {
        ...
        EnumFlowerType(final EnumFlowerColor blockType, final int meta, final String name) {
            this(blockType, meta, name, name);
        }

        EnumFlowerType(final EnumFlowerColor blockType, final int meta, final String name, final String unlocalizedName) {
        ...
        public static EnumFlowerType getType(final EnumFlowerColor blockType, int meta) {
            final EnumFlowerType[] ablockflower$enumflowertype = TYPES_FOR_BLOCK[blockType.ordinal()];
