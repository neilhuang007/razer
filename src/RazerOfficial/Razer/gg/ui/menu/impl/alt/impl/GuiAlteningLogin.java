...
import RazerOfficial.Razer.gg.util.thealtening.TheAltening;
import RazerOfficial.Razer.gg.util.thealtening.domain.Account;
...
public final class GuiAlteningLogin extends GuiScreen {
        ...
        switch (button.id) {
            ...
            case 0:
                if (!token.getText().isEmpty()) {
                    Razer.INSTANCE.getAccountManager().setAlteningToken(token.getText());
    ...
    public void initGui() {
        ...
        if (Razer.INSTANCE.getAccountManager().getAlteningToken() != null)
            token.setText(Razer.INSTANCE.getAccountManager().getAlteningToken());
