package RazerOfficial.Razer.gg.ui.click.standard;
...
import RazerOfficial.Razer.gg.ui.click.standard.components.category.SidebarCategory;
import RazerOfficial.Razer.gg.ui.click.standard.components.value.ValueComponent;
import RazerOfficial.Razer.gg.ui.click.standard.components.value.impl.StringValueComponent;
...
//        Razer.INSTANCE.getNetworkManager().getCommunication().write(new ClientCommunityPopulateRequest());
    }
