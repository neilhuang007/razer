...
import RazerOfficial.Razer.gg.script.api.wrapper.impl.ScriptMCFontRenderer;
import RazerOfficial.Razer.gg.script.api.wrapper.impl.ScriptRiseFontRenderer;
import RazerOfficial.Razer.gg.script.api.wrapper.impl.vector.ScriptVector3;
import RazerOfficial.Razer.gg.util.font.impl.rise.FontRenderer;
...
public class RenderAPI extends API {
    ...
    public int[] getThemeColor() {
        int[] f = new int[4];
        Color c = Razer.INSTANCE.getThemeManager().getTheme().getFirstColor();
        f[0] = c.getRed();
        f[1] = c.getGreen();
        f[2] = c.getBlue();
        f[3] = c.getAlpha();
