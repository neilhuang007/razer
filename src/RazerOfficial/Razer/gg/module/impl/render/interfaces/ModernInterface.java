...
public class ModernInterface extends Mode<Interface> {
    ...
    private final RazerOfficial.Razer.gg.util.font.Font productSansMedium36 = FontManager.getProductSansMedium(36);
    private final RazerOfficial.Razer.gg.util.font.Font productSansRegular = FontManager.getProductSansRegular(18);
    private final RazerOfficial.Razer.gg.util.font.Font minecraft = FontManager.getMinecraft();

    private RazerOfficial.Razer.gg.util.font.Font arrayListFont = productSansRegular;
    ...
    public final Listener<Render2DEvent> onRender2D = event -> {
        ...
        if (mc == null || mc.gameSettings.showDebugInfo || mc.theWorld == null || mc.thePlayer == null || Razer.CLIENT_TYPE != Type.RISE) {
            return;
        }
