package RazerOfficial.Razer.gg.util.file.alt;

import RazerOfficial.Razer.gg.Razer;
import RazerOfficial.Razer.gg.util.account.Account;
 ...
 * @since 10/19/2021
 */
public class AltFile extends RazerOfficial.Razer.gg.util.file.File {
    ...
    public boolean read() {
        ...
        Razer.INSTANCE.getAltManager().getAccounts().clear();
        ...
        try {
            ...
            for (Map.Entry<String, JsonElement> jsonElement : jsonObject.entrySet()) {
                ...
                Razer.INSTANCE.getAltManager().getAccounts().add(account);
            }
    ...
    public boolean write() {
        try {
            ...
            for (Account account : Razer.INSTANCE.getAltManager().getAccounts()) {
