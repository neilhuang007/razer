package me.neilhuang007.razer.anticheat.check.impl.movement;
...
import me.neilhuang007.razer.anticheat.util.PacketUtil;
...
public final class FlightPrediction extends Check {
    ...
    public void handle(final Packet<?> packet) {
        ...
        if (((PacketUtil.isRelMove(packet) && ((S14PacketEntity) packet).entityId == data.getPlayer().getEntityId()) ||
             ...
             * this is used to prevent false positives because the server may not send the razer ground position sometimes
